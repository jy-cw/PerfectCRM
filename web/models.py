...
class UserInfo(RbacUserInfo):
    ...
    depart = models.ForeignKey(verbose_name='部门', to="Department", to_field="code",default=1,on_delete=models.CASCADE)
...
class Customer(models.Model):
    ...
    referral_from = models.ForeignKey(
        ...
        related_name="internal_referral",on_delete=models.CASCADE
    )
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', related_name='consultanter',null=True, blank=True,on_delete=models.CASCADE)

    date = models.DateField(verbose_name="咨询日期", auto_now_add=True)
    recv_date = models.DateField(verbose_name="当前课程顾问的接单日期", blank=True, null=True)
    last_consult_date = models.DateField(verbose_name="最后跟进日期", blank=True, null=True)
